...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>multiply Rate Effect</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link clicker_Generator.impl.multiplyRateEffectImpl#getFactor <em>Factor</em>}</li>
 *   <li>{@link clicker_Generator.impl.multiplyRateEffectImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class multiplyRateEffectImpl extends effectImpl implements multiplyRateEffect {
	/**
	 ...
	 * @generated
	 */
	protected multiplyRateEffectImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Clicker_GeneratorPackage.Literals.MULTIPLY_RATE_EFFECT;
	}
	...
	public void setFactor(double newFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Clicker_GeneratorPackage.MULTIPLY_RATE_EFFECT__FACTOR,
					oldFactor, factor));
	}
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Clicker_GeneratorPackage.MULTIPLY_RATE_EFFECT__TARGET, oldTarget, target));
			}
		}
		return target;
	}
