...
/**
 * This is the item provider adapter for a {@link clicker_Generator.comparison} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class comparisonItemProvider extends expressionItemProvider {
	...
	protected void addResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_comparison_resource_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_comparison_resource_feature",
								"_UI_comparison_type"),
						Clicker_GeneratorPackage.Literals.COMPARISON__RESOURCE, true, false, true, null, null, null));
	}
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_comparison_operator_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_comparison_operator_feature",
								"_UI_comparison_type"),
						Clicker_GeneratorPackage.Literals.COMPARISON__OPERATOR, true, false, false,
